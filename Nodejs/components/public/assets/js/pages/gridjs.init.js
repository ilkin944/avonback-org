...
if (document.getElementById("table-gridjs"))
    new gridjs.Grid({
        ...
        },
        {
            ...
            width: '220px',
            formatter: (function (cell) {
                return gridjs.html('<a href="javascript:void(0);">' + cell + '</a>');
            })
        },
        {
            name: 'Position',
        ...
        },
        {
            ...
            width: '150px',
            formatter: (function (cell) {
                return gridjs.html("<a href='javascript:void(0);' class='text-reset text-decoration-underline'>" +
                    "Details" +
                    "</a>");
            })
        },
...
if (document.getElementById("table-pagination"))
    new gridjs.Grid({
        columns: [{
            ...
            width: '120px',
            formatter: (function (cell) {
                return gridjs.html('<a href="javascript:void(0);" class="fw-medium">' + cell + '</a>');
            })
        }, {
            name: 'Name',
            width: '150px',
