    ...
    document.getElementById("custom-sa-community").addEventListener("click", function () {
        Swal.fire({
            ...
            html: '<div class="mt-3 text-start">' +
                ...
                '</div>',
            imageUrl: '../assets/images/logo-sm.png',
            footer: '<p class="fs-13 text-muted mb-0">Already have an account ? <a href="javascript:void(0);" class="fw-semibold text-decoration-underline"> Signin </a> </p>',
            imageHeight: 40,
...
if (document.getElementById("custom-sa-email-verify"))
    document.getElementById("custom-sa-email-verify").addEventListener("click", function () {
        Swal.fire({
            ...
            buttonsStyling: false,
            footer: '<p class="fs-14 text-muted mb-0">Didn\'t receive an email ? <a href="javascript:void(0);" class="fw-semibold text-decoration-underline">Resend</a></p>',
            showCloseButton: true
        })
    });
