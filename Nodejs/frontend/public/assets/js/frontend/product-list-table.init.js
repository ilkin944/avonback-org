                ...
                data: (function (row) {
                    return gridjs.html('<div class="text-center dropdown">\
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">\
                            <li>\
                                <a class="dropdown-item" href="javascript:void(0);"><i class="ri-eye-line me-2 align-bottom text-muted"></i>view</a>\
                            </li>\
                            <li>\
                                <a class="dropdown-item" href="javascript:void(0);"><i class="ri-shopping-cart-line me-2 align-bottom text-muted"></i>cart</a>\
                            </li>\
                        </ul>\
                    </div>');
                })
