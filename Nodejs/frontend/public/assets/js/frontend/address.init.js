/*
Template Name: Toner eCommerce + Admin Node js Template
Author: Themesbrand
Version: 1.0.0
        ...
        document.getElementById("address-list").innerHTML += '<div class="col-lg-6">\
                        <div>\
                            ...
                            <div class="d-flex flex-wrap p-2 py-1 bg-light rounded-bottom border mt-n1 fs-13">\
                                <div>\
                                    <a href="javascript:void(0);" class="d-block text-body p-1 px-2 edit-list" data-edit-id="'+ listdata.id + '" data-bs-toggle="modal" data-bs-target="#addAddressModal"><i class="ri-pencil-fill text-muted align-bottom me-1"></i> Edit</a>\
                                </div>\
                                <div>\
                                    <a href="javascript:void(0);" class="d-block text-body p-1 px-2 remove-list" data-remove-id="'+ listdata.id + '" data-bs-toggle="modal" data-bs-target="#removeAddressModal"><i class="ri-delete-bin-fill text-muted align-bottom me-1"></i> Remove</a>\
                                </div>\
                            </div>\
                        </div>\
                    </div>';
