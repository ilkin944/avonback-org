        ...
        if (datas[i]) {
            ...
            if (datas[i].subCategory) {
                Array.from(subCategoryElem.slice(0, showElem)).forEach(function (elem) {
                    subCategoryHtml += '<li><a href="javascript:void(0);" class="text-muted">' + elem + '</a></li>';
                });
            }
                        ...
                        <div class="card-body p-4">\
                            <div class="d-flex align-items-center mb-3">\
                                ...
                                <ul class="flex-shrink-0 list-unstyled hstack gap-1 mb-0">\
                                    <li><a href="javascript:void(0);" class="badge badge-soft-info edit-list" data-edit-id="'+ datas[i].id + '">Edit</a></li>\
            ...
            categoryListData = categoryListData.map(function (item) {
                if (item.id == getViewid) {
                    ...
                    item.subCategory.map(function (subItem) {
                        document.querySelector('#overviewOffcanvas .subCategory').innerHTML += '<li><a href="javascript:void(0);" class="text-reset">' + subItem + '</a></li>'
                    });
