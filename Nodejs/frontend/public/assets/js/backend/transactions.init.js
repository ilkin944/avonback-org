    ...
    form.addEventListener('submit', function (event) {
        ...
        if (
            ...
            transactionsList.add({
                ...
                transactionID: `<a href="javascript:void(0);" class="fw-medium">${transactionIDField.value}</a>`,
...
xhttp.onload = function () {
    ...
    Array.from(json_records).forEach(function (element) {
        transactionsList.add({
            ...
            transactionID: `<a href="javascript:void(0);" class="fw-medium">${element.transactionID}</a>`,
